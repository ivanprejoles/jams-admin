...
const formSchema = z.object({
  ...
  colorId: z.string().array().min(1),
  sizeId: z.string().array().min(1),
  salesStatus: z.nativeEnum(SalesStatus).default(SalesStatus.SLOW),
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="md:w-full w-60">
                        <SelectValue
                          defaultValue={field.value}
                          placeholder="Select a Demand Status"
                        />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                        <SelectItem  value={SalesStatus.FAST}>
                          High Demand
                        </SelectItem>
                        <SelectItem  value={SalesStatus.SLOW}>
                          Low Demand
                        </SelectItem>
                    </SelectContent>
                  </Select>
