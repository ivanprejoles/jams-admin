...
import { CreditCardIcon, PoundSterlingIcon as PhilippinePesoIcon, Package } from 'lucide-react';
            ...
            <BackgroundGradient key={index} className="rounded-[22px]">
              <Card className="rounded-[20px] border-none bg-white/90 dark:bg-black/90  backdrop-blur-sm">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <AnimatedTooltip items={ {id: index, name: metric.description, image: "/logo.png", designation: metric.value} }>
